...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(54460969535995736)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3392950101478380)
,p_plug_template_id=>wwv_flow_imp.id(54460969535995736)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3393443964478380)
,p_plug_template_id=>wwv_flow_imp.id(54460969535995736)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3393933352478381)
,p_plug_template_id=>wwv_flow_imp.id(54460969535995736)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3394433679478381)
,p_plug_template_id=>wwv_flow_imp.id(54460969535995736)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3394908579478381)
,p_plug_template_id=>wwv_flow_imp.id(54460969535995736)
,p_name=>'Sub Regions'
