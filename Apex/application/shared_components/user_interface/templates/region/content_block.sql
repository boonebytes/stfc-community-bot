...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(54450065892995729)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3344979959478353)
,p_plug_template_id=>wwv_flow_imp.id(54450065892995729)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3345497682478353)
,p_plug_template_id=>wwv_flow_imp.id(54450065892995729)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3345969800478353)
,p_plug_template_id=>wwv_flow_imp.id(54450065892995729)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3346453183478353)
,p_plug_template_id=>wwv_flow_imp.id(54450065892995729)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3346973765478354)
,p_plug_template_id=>wwv_flow_imp.id(54450065892995729)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3347453350478354)
,p_plug_template_id=>wwv_flow_imp.id(54450065892995729)
,p_name=>'Sub Regions'
