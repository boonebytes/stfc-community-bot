...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3457756492478418)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3458299877478418)
,p_plug_template_id=>wwv_flow_imp.id(3457756492478418)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3458700984478418)
,p_plug_template_id=>wwv_flow_imp.id(3457756492478418)
,p_name=>'Sub Regions'
