...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(54434419117995718)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3288593335478320)
,p_plug_template_id=>wwv_flow_imp.id(54434419117995718)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3289083378478320)
,p_plug_template_id=>wwv_flow_imp.id(54434419117995718)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3289585630478320)
,p_plug_template_id=>wwv_flow_imp.id(54434419117995718)
,p_name=>'Sub Regions'
