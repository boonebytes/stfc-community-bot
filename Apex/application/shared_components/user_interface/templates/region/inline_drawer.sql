...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3449712233478412)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3450292378478414)
,p_plug_template_id=>wwv_flow_imp.id(3449712233478412)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3450719792478414)
,p_plug_template_id=>wwv_flow_imp.id(3449712233478412)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3451204120478414)
,p_plug_template_id=>wwv_flow_imp.id(3449712233478412)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3451777659478414)
,p_plug_template_id=>wwv_flow_imp.id(3449712233478412)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3452242275478415)
,p_plug_template_id=>wwv_flow_imp.id(3449712233478412)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3452792610478415)
,p_plug_template_id=>wwv_flow_imp.id(3449712233478412)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3453243605478415)
,p_plug_template_id=>wwv_flow_imp.id(3449712233478412)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3453783003478416)
,p_plug_template_id=>wwv_flow_imp.id(3449712233478412)
,p_name=>'Sub Regions'
