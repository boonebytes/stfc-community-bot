...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(54468995196995740)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3426112354478399)
,p_plug_template_id=>wwv_flow_imp.id(54468995196995740)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3426684869478399)
,p_plug_template_id=>wwv_flow_imp.id(54468995196995740)
,p_name=>'Tabs'
