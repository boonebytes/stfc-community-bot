...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(54452459016995731)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3353689737478358)
,p_plug_template_id=>wwv_flow_imp.id(54452459016995731)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3354172126478358)
,p_plug_template_id=>wwv_flow_imp.id(54452459016995731)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3354615050478358)
,p_plug_template_id=>wwv_flow_imp.id(54452459016995731)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3355113238478358)
,p_plug_template_id=>wwv_flow_imp.id(54452459016995731)
,p_name=>'Sub Regions'
