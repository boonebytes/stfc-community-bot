...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(56625808339916616)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(56626257629916620)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(56625808339916616)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(56626093472916618)
,p_name=>'P20_MEMBER_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(56625808339916616)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(56626171570916619)
...
,p_cSize=>70
,p_cHeight=>20
,p_field_template=>wwv_flow_api.id(54524887331995797)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(56626773708916625)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(56626810777916626)
,p_event_id=>wwv_flow_api.id(56626773708916625)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(56626579164916623)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(56625979826916617)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_api.id(56625808339916616)
