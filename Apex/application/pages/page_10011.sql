...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(54569556700996029)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(54570666796996029)
,p_name=>'Manage User Access'
...
,p_owner=>'BOONEBYTES'
,p_internal_uid=>24170387093898354
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54570687206996041)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54571133514996045)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54571540885996045)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(54572215900996048)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'241720'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(54573106032996050)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(54569556700996029)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(54573508947996051)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(54573929811996051)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(54569641182996029)
,p_name=>'Refresh on Dialog Close'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(54569556700996029)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(54574508703996052)
,p_event_id=>wwv_flow_api.id(54569641182996029)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(54569556700996029)
);
